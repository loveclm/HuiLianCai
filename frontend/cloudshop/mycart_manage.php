...
<div class="page-wrapper">
    <div class="page-content-wrapper">
        <div class="page-content" style="">
            <div id="product_container" class="product_container" style="overflow-y: scroll; overflow-x: hidden;">
            </div>
...
<script type="text/javascript" src="assets/js/mycart_manage.js"></script>
