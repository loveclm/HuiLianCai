...
<div id="auth_question" class="modal fade " tabindex="-1" data-backdrop="basic" data-keyboard="false">
    <div class="modal-body">
        <b><center>注册成功，请您及时进行认证！</center></b>
    </div>
    <div class="modal-footer">
        <button id="auth_cancel" type="button" class="btn_custom btn-default" onclick="OnCancel()">跳过</button>
        <button id="auth_ok" type="button" class="btn_custom" onclick="OnOk()">立即认证</button>
    </div>
</div>
...
<script type="text/javascript">
    ...
    var pageShopId = parseInt(<?=$pageShopId?>); //sId - int
    var pageItemType = parseInt(<?=$pageItemType?>); //iType - int
    var pageItemId = parseInt(<?=$pageItemId?>); //iId -int
    var pageType=<?=$pageItemId?>; //iId - string
