...
<body>
    ...
    <div class="col-md-offset-4 col-md-4 col-xs-offset-1 col-xs-10">
        <div class="form-group form-md-line-input custom_row">
            <input type="number" class="form-control" maxlength="11" id="phone_number">
        ...
        <div id="forget_password" onclick="javascript: window.location.href='forget_password.html'">忘记密码？</div>
        <div id="login_button" class="btn_login" onclick="OnLogin()">登录</div>
        <div id="register" onclick="javaScript: location.href='register.php'"><u>没有账号？立即注册</u></div>
