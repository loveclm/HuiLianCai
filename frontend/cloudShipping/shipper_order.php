...
<div class="page-wrapper">
    <div class="page-content-wrapper">
        <div class="page-content" style="">
            ...
            <div id="horizontal_menu_bar" class="shipper-order">
            </div>
            <div id="detail_menu">
...
<div class="page-footer">
    ...
    <div class="bottom_item" style="width: 33%" onclick="selectShipperBottomItem(3,0)">
        <img src="assets/images/dist_tabbar_icon3_n@2x.png" id="bottom_item_image3">
...
<script type="text/javascript" src="assets/js/shipper_order.js"></script>
