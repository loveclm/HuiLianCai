                    ...
                    <div class="row">
                        <div class="col-xs-6 col-sm-4 form-inline">
                            <div class="form-group area-search-control-view">
                                <a class="btn btn-primary form-control" href="<?php echo base_url(); ?>multiple_activity_add">
                                    <span>新增活动</span>
                                </a>
                            </div>
                        </div>
...
<script type="text/javascript" src="<?php echo base_url(); ?>assets/js/activity_manage/multiple_activity.js" charset="utf-8"></script>
