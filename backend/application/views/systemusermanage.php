        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-2 form-inline">
                    <div class="form-group">
                        <button class="btn btn-primary searchList" onclick="searchArea('http://www.ayoubc.com/backend/');">查询</button>
                    </div>
                </div>
                </form>
            </div>
            <div class="row">
                <div class="col-xs-6 col-sm-4 form-inline">
                    <div class="form-group area-search-control-view">
                        <a class="btn btn-primary form-control" href="<?php echo base_url(); ?>addNew">
                            <span>添加人员</span>
                        </a>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div id="custom-generate-auth-count-view" style="display:none;">
                        ...
                        <div class="form-group">
                            ...
                            <button class="btn btn-primary" onclick="resetPassword('<?php echo base_url(); ?>', );">
                                确认
                            </button>
                        </div>
