                    ...
                    <div class="row form-inline">
                        ...
                        <div class="input-group margin">
                            <input name="bank_name" type="text" id="bank_name" class="form-control"
                                   ...
                                   style="margin: 0 ; padding: 0px 20px;" <?php echo (isset($id) && $id !='') ? 'disabled' : ''; ?> disabled/>
                        </div>
                    </div>
                    <div class="row form-inline">
                        <label> *持卡人 : </label>
                    ...
                    <div class="row form-inline">
                        ...
                        <div class="input-group margin">
                            <input name="cert_no" type="text" id="cert_no" class="form-control"
                                   value="<?php echo isset($model->cert_no) ? substr($model->cert_no,0,3).'****'.substr($model->cert_no,14) : ''; ?>"
                                   style="margin: 0 ; padding: 0px 20px;" disabled />
                        </div>
                    </div>
                    <div class="row form-inline">
                        ...
                        <div class="input-group margin">
                            <input name="card_no" type="text" id="card_no" class="form-control"
                                   value="<?php echo isset($model->card_no) ? '*******'.substr($model->card_no, count($model->card_no)-5) : ''; ?>"
                                   style="margin: 0 ; padding: 0px 20px;" disabled />
                        </div>
                    </div>
                    <div class="row form-inline">
                        ...
                        <div class="input-group margin">
                            <input name="reserve_mobile" type="text" id="reserve_mobile" class="form-control" placeholder="银行预留手机号"
                                   value="<?php echo isset($model->reserve_mobile) ? substr($model->reserve_mobile,0,4).'***'.substr($model->reserve_mobile, 8) : ''; ?>"
                                   style="margin: 0 ; padding: 0px 20px;" disabled />
