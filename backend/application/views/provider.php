                ...
                <div class="col-xs-12 col-sm-4 form-inline">
                    <div class="form-group">
                        <select class="form-control" id="searchType">
                            <option value="0" <?php if ($searchStatus == 0) echo ' selected' ?>>供货商账号</option>
                            <option value="1" <?php if ($searchStatus == 1) echo ' selected' ?>>供货商名称</option>
                            <option value="2" <?php if ($searchStatus == 2) echo ' selected' ?>>联系人</option>
                            <option value="3" <?php if ($searchStatus == 3) echo ' selected' ?>>推荐业务员</option>
                        </select>
