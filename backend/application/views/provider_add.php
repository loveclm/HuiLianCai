                ...
                <form role="form" id="addProvider" action="<?php echo base_url() ?>provider_add" method="post">
                    ...
                    <div class="row form-inline">
                        ...
                        <div class="input-group margin">
                            <input name="password" type="text" id="password" class="form-control"
                                   value="<?php echo isset($provider) ? $provider->password : ''; ?>"
                                   style="margin: 0 ; padding: 0px 20px;"/>
                        </div>
                    </div>
                    <div class="row form-inline">
                        ...
                        <div class="input-group margin">
                            <input name="provider_name" type="text" id="provider_name" class="form-control"
                                   value="<?php echo isset($provider) ? $provider->name : ''; ?>"
                                   style="margin: 0 ; padding: 0px 20px;"/>
                        </div>
                    </div>
                    ...
                    <div class="row form-inline">
                        ...
                        <textarea name="content" class="form-control" rows="3" placeholder=""
                                  style="margin: 0px -1px 0px 0px; min-width: 400px; max-height: 150px; max-width:400px; "><?php echo isset($more_data) ? $more_data->content : ''; ?></textarea>
                        </div>
                    </div>
                    <div class="row form-inline">
                        <label> *公司LOGO : </label>
                        ...
                        <div id="company_logo_content" class="input-group margin">
                            <div class="form-group text-center" style="padding: 0px 20px;">
                                ...
                                ?>
                                <img id="company_logo_image" src="<?= $company_logo[1]; ?>"
                                     alt="user image" class="online" style="height: 150px; width:200px;"><br>
                    ...
                    <div class="row form-inline">
                        ...
                        <div id="company_cert_content" class="input-group margin">
                            <div class="form-group text-center" style="padding: 0px 20px;">
                                ...
                                ?>
                                <img id="company_cert_image" src="<?= $company_cert[1]; ?>"
                                     alt="user image" class="online" style="height: 150px; width:200px;"><br>
                    ...
                    <div class="row form-inline">
                        ...
                        <div id="company_brand_content" class="input-group margin" style="width: 100%">
                            <div class="form-group text-center" style="padding: 0px 20px;">
                                <?php
                                ...
                                foreach ($company_brand_list as $company_brand) {
                                    ...
                                    <div class="company_brand" style="float: left;">
                                        <img id="<?= 'company_brand' . $i . '_image' ?>" src="<?= $company_brand[1]; ?>"
                    ...
                    <div class="row form-inline">
                        ...
                        <div class="input-group margin">
                            ...
                            <input name="percent" type="text" id="percent"
                                   value="<?= isset($more_data) ? $more_data->percent : 0; ?>"
                    ...
                    <div class="row form-inline">
                        <label> 推荐业务员 : </label>
                        <div class="input-group margin">
                            <select name="saleman" class="form-control" id="searchType">
                                <?php
                                if (count($salemans) > 0) {
                                    $i = 0;
                                    $select_state = 0;
                                    foreach ($salemans as $item) {
                                        $i++;
                                        if (isset($more_data))
                                            if ($item == $provider->saleman) $select_state = 1;

                                        if ($select_state == 1) {
                                            ?>
                                            <option value="<?php echo $item; ?>" selected><?= $item; ?></option>
                                            <?php
                                        } else {
                                            ?>
                        ...
                        <div class="row">
                            <div class="col-xs-12 col-sm-12 form-inline">
                                <a class="btn btn-default form-control" href="<?php echo base_url(); ?>provider">
                                    <span>取消</span>
                                </a>
...
<script type="text/javascript" src="<?php echo base_url(); ?>assets/js/provider.js" charset="utf-8"></script>
<script
